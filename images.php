...
$icons = array(
    ...
    '10d' => array(500, 501, 502, 503, 504),                                    // а если бы я внимательно читал api
    '09d' => array(511, 520, 521, 522, 531),                                    // то заметил бы что там передается название файла
    '13d' => array(600, 601, 602, 611, 612, 615, 616, 620, 621, 622),           // и не надо было ничего городить
